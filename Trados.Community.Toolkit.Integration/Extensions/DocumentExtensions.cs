...
namespace Trados.Community.Toolkit.Integration.Extensions
{
    public static class DocumentExtensions
    {
        public static ProjectFile TryGetActiveFile(this Document document)
        {
            ...
            var distinctFileContainerNodes = fileContainerNodes.
                DistinctBy(x => x.FileProperties.FileConversionProperties.FileId).ToList();
